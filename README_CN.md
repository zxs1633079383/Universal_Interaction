...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/状态-✅_MVP完成-success?style=for-the-badge" alt="Status">
  <img src="https://img.shields.io/badge/语言-Go-00ADD8?style=for-the-badge&logo=go" alt="Go">
</p>
...
| 🔄 **双向通信** | 支持同步请求和异步回调              |
| 🧩 **可扩展** | 插件化适配器架构                 |
| 🤝 **Moltbot 深度集成** | 复用二次开发 `universal-im` 插件 |
...
| 项目 | 说明                            |
|------|-------------------------------|
| [Moltbot (Fork)](https://github.com/zxs1633079383/moltbot) | Molibot 核心，包含 universal-im 插件 |
...
# 查看 AI 响应结果
tail -30 /tmp/moltbot/moltbot-$(date +%Y-%m-%d).log | grep -E "\[universal-im\]"
```
